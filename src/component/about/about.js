...
export const About = () => {
    return (
        <div className={"about content"}>
            <div className={"aboutInfo"}>     {/*left part*/}
                <div className={"title"}>
                    <p>About</p>
                    <p>Premier Foods</p>
                </div>
                <div className={"textContent"}>
                    The company was founded 2012 year. In the first half becoming a food producer Nestle Company:
                    (brands: KitKat, Nesquik, Nuts, Good Mix, Nestle, Rossia, Nescafe, BonPari, Bistroff, Torchin,
